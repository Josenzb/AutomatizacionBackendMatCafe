...
public class EditarCursoPorIdDejandoCamposVaciosStepDefinition  extends ApiSetUp {

    public static Logger LOGGER= Logger.getLogger(EditarCursoPorIdDejandoCamposVaciosStepDefinition.class);
    ...
    public void queElAdministradorDejaCamposVaciosCuandoEditaLaInformacionDeUnCurso() {
        try {
    ...
    @When("envia  alguno de los siguientes campos vavios titulo {string}, descripcion {string}, duracion {string}, requerimiento {string}, contenido  {string} y el adminID {string}, con el id del curso a editar {string}")
    public void enviaAlgunoDeLosSiguientesCamposVaviosTituloDescripcionDuracionRequerimientoContenidoYElAdminIDConElIdDelCursoAEditar(String titulo, String descripcion, String duracion, String requerimiento, String contenido, String adminID, String idCurso) {
    ...
    @Then("se generara un mensaje de error junto con un  estatus {int}")
    public void seGeneraraUnMensajeDeErrorJuntoConUnEstatus(Integer statusCode) {
