...
public class CrearLearnerCaracteresEspeciales extends ApiSetUp {

    public static Logger LOGGER= Logger.getLogger(CrearLearnerCaracteresEspeciales.class);
    ...
    @When("el administrador envia la peticion con el nombre truncado {string} y el email  {string} para aprendiz")
    public void elAdministradorEnviaLaPeticionConElNombreTruncadoYElEmailParaAprendiz(String nombre, String correo) {
        try{
