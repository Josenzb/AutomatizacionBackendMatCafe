...
public class SuscribirAprendizEnUnaRutaDeFormaExitosaStepDefinition extends ApiSetUp {

    public static Logger LOGGER= Logger.getLogger(SuscribirAprendizEnUnaRutaDeFormaExitosaStepDefinition.class);
    ...
    public void elAdministradorDeseaInscribirUnAprendizAUnaRutaDeAprendizaje() {
    ...
    @When("envia el reto con los datos de  id del aprendiz {string} y  id del curso {string}")
    public void enviaElRetoConLosDatosDeIdDelAprendizYIdDelCurso(String idAprendiz, String IdRuta) {
        try {
    ...
    @Then("se inscribe el aprendiz a la ruta y se muestra un esatatus {int}")
    public void seInscribeElAprendizALaRutaYSeMuestraUnEsatatus(Integer statusCode) {
