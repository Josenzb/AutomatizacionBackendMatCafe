Feature: Calificar taller
  ...
  Scenario Outline: Calificar reto exitoso
    ...
    When el administrador envía la petición con la <calificacion> el comentario <comentario> el idcurso <courseid> y la idaprendiz <idlearner>
  ...
  Scenario Outline: Calificar reto con valores limite
    ...
    When el administrador envía la petición con al limite <calificacion> el comentario <comentario> el idcurso <courseid> y la idaprendiz <idlearner>
  ...
  Scenario Outline: Calificar reto con id de curso incorrecta
    ...
    When el administrador envía la petición con la <calificacion> el comentario <comentario> el idcurso erronea <courseid> y la idaprendiz <idlearner>
