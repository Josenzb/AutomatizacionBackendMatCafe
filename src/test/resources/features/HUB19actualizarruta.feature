Feature: Actualizar ruta de aprendizaje
  ...
  Scenario Outline: actualizar rutas de aprendizaje de manera exitosa
    ...
    Examples:
      ...
      | "Ruta Actualizada" | "Mi ruta actualizada" | "5 horas" | 200  | "644739c75681b2a2806c11bb" | "64495081d5f5ed32cf12a55a" |
      | "Ruta QA"          | "Descripcion ruta QA" | "8 horas" | 200  | "644739c75681b2a2806c11bb" | "64495081d5f5ed32cf12a55a" |
  ...
  Scenario Outline: actualizar rutas de aprendizaje enviando caracteres especiales
    ...
    Examples:
      | title    | description           | duration | code | adminId                    | id                         |
      | "345569" | "Mi ruta actualizada" | "5 ??"   | 409  | "644739c75681b2a2806c11bb" | "64481f7de11f94e014380d64" |
      | "345569" | "Mi ruta actualizada" | "5 ??"   | 409  | "644739c75681b2a2806c11bb" | "64481f7de11f94e014380d64" |
      | "345 "   | "m1 rut4"             | "5 ??"   | 409  | "644739c75681b2a2806c11bb" | "64481f7de11f94e014380d64" |
      | "++++ p" | ""                    | "5 ?9"   | 409  | "644739c75681b2a2806c11bb" | "64481f7de11f94e014380d64" |
  ...
  Scenario Outline: actualizar rutas de aprendizaje enviando campos vacios con admin Id y Id validos
    ...
    Examples:
      | title                  | description           | duration  | code | adminId                    | id                         |
      | " "                    | "Mi ruta actualizada" | "5 horas" | 409  | "644739c75681b2a2806c11bb" | "64481f7de11f94e014380d64" |
      | "Ruta de prueba "      | " "                   | "5 horas" | 409  | "644739c75681b2a2806c11bb" | "64481f7de11f94e014380d64" |
      | "Ruta de prueba vol.1" | "Actualizando ruta"   | " "       | 409  | "644739c75681b2a2806c11bb" | "64481f7de11f94e014380d64" |
      | ""                     | ""                    | ""        | 409  | "644739c75681b2a2806c11bb" | "644739c75681b2a2806c11bb" |
  ...
  Scenario Outline: actualizar rutas de aprendizaje con id no registrados
    ...
    Examples:
      | title                        | description           | duration  | code | adminId                   | id                        |
      | "Nueva ruta de aprendizaje " | "Mi ruta actualizada" | "5 horas" | 409  | "644739c75681b2a2806c11b" | "64481f7de11f94e014380d4" |
      | "Ruta de prueba "            | " "                   | "5 horas" | 409  | "644739c75681b22806c11bb" | "6448f7de11f94e014380d64" |